...
const PagarFacturas = () => {
  ...
  return (
    <><section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
      <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
        <div className="mx-auto max-w-5xl">
          <h2 classNName="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Payment</h2>
    ...
    </section><script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/2.3.0/datepicker.min.js"></script></>
  );
};
